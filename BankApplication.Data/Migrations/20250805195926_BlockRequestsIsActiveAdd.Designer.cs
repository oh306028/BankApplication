...
namespace BankApplication.Data.Migrations
{
    ...
    [Migration("20250805195926_BlockRequestsIsActiveAdd")]
    partial class BlockRequestsIsActiveAdd
    {
            ...
            modelBuilder.Entity("BankApplication.Data.Entities.BankAccountBlockRequest", b =>
                {
                    ...
                    b.HasOne("BankApplication.Data.Entities.BankAccount", "BankAccount")
                        .WithOne("BlockadeRequest")
                        .HasForeignKey("BankApplication.Data.Entities.BankAccountBlockRequest", "BankAccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
