...
namespace BankApplication.Data.Migrations
{
    ...
    [Migration("20250808101615_ClientRequestsTableAdd")]
    partial class ClientRequestsTableAdd
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankApplication.Data.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PublicId = new Guid("112c4e2c-9977-4cea-8129-9d2e32c53d0e"),
                            WrongLoginAmount = 0
                        });
                });
            ...
            modelBuilder.Entity("BankApplication.Data.Entities.BankAccountBlockRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("BankAccountBlockRequests", (string)null);
                });
            ...
            modelBuilder.Entity("BankApplication.Data.Entities.BecomeClientRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("BecomeClientRequests", (string)null);
                });
            ...
            modelBuilder.Entity("BankApplication.Data.Entities.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Phone = "",
                            PostalCode = "",
                            PublicId = new Guid("26ce87e3-7c07-41da-a0de-a155c1d10398")
                        });
                });
            ...
            modelBuilder.Entity("BankApplication.Data.Entities.BankAccountBlockRequest", b =>
                {
                    b.HasOne("BankApplication.Data.Entities.Client", "Admin")
                        .WithMany("BlockRequests")
                        .HasForeignKey("AdminId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("BankApplication.Data.Entities.BankAccount", "BankAccount")
                        .WithMany("BlockadeRequests")
            ...
            modelBuilder.Entity("BankApplication.Data.Entities.BecomeClientRequest", b =>
                {
                    ...
                    b.HasOne("BankApplication.Data.Entities.Client", "Client")
                        ...
                        .HasForeignKey("BankApplication.Data.Entities.BecomeClientRequest", "ClientId")
