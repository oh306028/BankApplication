...
namespace BankApplication.Data.Migrations
{
    ...
    [Migration("20250727115349_amountToBalanceChange")]
    partial class amountToBalanceChange
    {
            ...
            modelBuilder.Entity("BankApplication.Data.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PublicId = new Guid("594377f9-617f-47ab-ac20-a1b216d7ed36"),
                            WrongLoginAmount = 0
                        });
                });
            ...
            modelBuilder.Entity("BankApplication.Data.Entities.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Phone = "",
                            PostalCode = "",
                            PublicId = new Guid("278b08da-a086-40cc-bef5-549a156ffba4")
                        });
                });
