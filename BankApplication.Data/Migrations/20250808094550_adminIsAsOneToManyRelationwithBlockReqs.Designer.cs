...
namespace BankApplication.Data.Migrations
{
    ...
    [Migration("20250808094550_adminIsAsOneToManyRelationwithBlockReqs")]
    partial class adminIsAsOneToManyRelationwithBlockReqs
    {
            ...
            modelBuilder.Entity("BankApplication.Data.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PublicId = new Guid("6223c367-f858-4aad-81a9-6735278c358d"),
                            WrongLoginAmount = 0
                        });
                });
            ...
            modelBuilder.Entity("BankApplication.Data.Entities.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Phone = "",
                            PostalCode = "",
                            PublicId = new Guid("c21704bd-4985-45d7-abc2-a2412d2c74ca")
                        });
                });
