...
namespace BankApplication.Data.Migrations
{
    ...
    [Migration("20250517163919_adminAccountAdd")]
    partial class adminAccountAdd
    {
            ...
            modelBuilder.Entity("BankApplication.Data.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PublicId = new Guid("15f8709a-1730-4661-91df-75e5514d3818"),
                            WrongLoginAmount = 0
                        });
                });
            ...
            modelBuilder.Entity("BankApplication.Data.Entities.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Phone = "",
                            PostalCode = "",
                            PublicId = new Guid("d562dccb-cf1c-4de8-9a30-2cc792951072")
                        });
                });
