...
namespace BankApplication.Data.Migrations
{
    ...
    [Migration("20250517171334_addressMaximumChange")]
    partial class addressMaximumChange
    {
            ...
            modelBuilder.Entity("BankApplication.Data.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsEmployee = true,
                            Login = "adminTab",
                            PasswordHash = "AQAAAAIAAYagAAAAEMRcgL0snx6ZAHU5PZRGzbn6a6nIR4TSfiKHhx6eEJk1FZ1FZKnZCJh0JGXYfWzKnA==",
                            PublicId = new Guid("fd696425-40d8-468c-9d2f-a36e84d421c4"),
                            WrongLoginAmount = 0
                        });
                });
            ...
            modelBuilder.Entity("BankApplication.Data.Entities.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Phone = "",
                            PostalCode = "",
                            PublicId = new Guid("bc70dbca-2986-4d68-a187-d1068fd0e245")
                        });
                });
