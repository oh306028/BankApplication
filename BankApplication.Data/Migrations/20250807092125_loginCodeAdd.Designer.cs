...
namespace BankApplication.Data.Migrations
{
    ...
    [Migration("20250807092125_loginCodeAdd")]
    partial class loginCodeAdd
    {
            ...
            modelBuilder.Entity("BankApplication.Data.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PublicId = new Guid("6624d839-5a36-4e50-a99a-acfcfdf7cceb"),
                            WrongLoginAmount = 0
                        });
                });
            ...
            modelBuilder.Entity("BankApplication.Data.Entities.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Phone = "",
                            PostalCode = "",
                            PublicId = new Guid("5f1d4e06-6aca-4366-b36a-1c20f3bda09a")
                        });
                });
            ...
            modelBuilder.Entity("BankApplication.Data.Entities.BankAccountBlockRequest", b =>
                {
                    b.HasOne("BankApplication.Data.Entities.Client", "Admin")
                        .WithOne("BlockRequest")
                        .HasForeignKey("BankApplication.Data.Entities.BankAccountBlockRequest", "AdminId")
